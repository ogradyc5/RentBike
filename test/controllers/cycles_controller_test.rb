...
class CyclesControllerTest < ActionController::TestCase
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post :create, cycle: { address: @cycle.address, latitude: @cycle.latitude, longitude: @cycle.longitude }
    end
  ...
  test "should update cycle" do
    patch :update, id: @cycle, cycle: { address: @cycle.address, latitude: @cycle.latitude, longitude: @cycle.longitude }
    assert_redirected_to cycle_path(assigns(:cycle))
  end
