module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      store_bike.bookings.end_during(start_time, end_time),
      store_bike.bookings.start_during(start_time, end_time),
      store_bike.bookings.happening_during(start_time, end_time),
      store_bike.bookings.enveloping(start_time, end_time),
      store_bike.bookings.identical(start_time, end_time)
    ].flatten
